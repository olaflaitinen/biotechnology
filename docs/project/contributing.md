<!--
  ...
  Produced by tools/generate_docs.py from CONTRIBUTING.md.
...
doctests, and a test module. See [`NOTATION.md`](../reference/notation.md) for the contract.
...
**Read [`STYLE_GUIDE.md`](style-guide.md).** It is normative, it is short, and
...
- pass `make all`;
- complete the review checklist from [`STYLE_GUIDE.md`](style-guide.md) §5.
...
Contributors are listed in [`AUTHORS.md`](https://github.com/olaflaitinen/biotechnology/blob/main/AUTHORS.md). If you would prefer not
...
Participation is governed by [`CODE_OF_CONDUCT.md`](code-of-conduct.md).
