...
| Member | Meaning | Records |
|---|---|---:|
| `ROUTINE` | Ordinary laboratory or factory work with standard safety rules. | 0 |
| `CONTROLLED` | Needs a permit, a licence or an institutional committee sign-off. | 0 |
| `REGULATED` | Overseen by a national agency before it may be sold or released. | 0 |
| `RESTRICTED` | Access to materials or methods is deliberately limited by law. | 0 |

## scale

| Member | Meaning | Records |
|---|---|---:|
| `BENCH` | Fits on a laboratory bench; millilitres to a few litres. | 0 |
| `PILOT` | A small demonstration plant; tens to thousands of litres. | 0 |
| `INDUSTRIAL` | A full production plant; cubic metres and upward. | 0 |
| `FIELD` | Open land, water or an animal herd rather than a vessel. | 0 |
| `POPULATION` | Whole communities, countries or ecosystems. | 0 |
