...
|---|---|---|---|
| [Plant Genetic Engineering](plant_genetic_engineering.md) | ESTABLISHED | FIELD | Introducing defined genes into crop genomes to confer traits such as insect resistance, herbicide tolerance or enhanced nutrition. |
| [Agricultural Genome Editing](agricultural_genome_editing.md) | COMMERCIAL | FIELD | Making targeted, often transgene-free edits in crop and livestock genomes rather than inserting foreign genes. |
| [Molecular Plant Breeding](molecular_plant_breeding.md) | ESTABLISHED | FIELD | Accelerating conventional breeding with DNA markers and genomic prediction so that selection happens at the seedling stage. |
| [Plant Tissue Culture and Micropropagation](plant_tissue_culture.md) | ESTABLISHED | INDUSTRIAL | Regenerating whole plants from cells, tissues or organs on sterile media to mass-produce uniform, disease-free planting material. |
| [Biofertilisers and Plant-Growth-Promoting Microbes](biofertilisers.md) | COMMERCIAL | FIELD | Living microbial inoculants that fix nitrogen, solubilise phosphate or stimulate root growth, substituting for part of the synthetic fertiliser load. |
| [Biopesticides and Biological Control](biopesticides.md) | COMMERCIAL | FIELD | Pest and disease management with living organisms or their natural products instead of broad-spectrum synthetic chemistry. |
| [Animal Biotechnology](animal_biotechnology.md) | COMMERCIAL | FIELD | Reproductive, genomic and genetic technologies applied to livestock to improve productivity, welfare and disease resistance. |
| [Veterinary Vaccines and Animal Health](veterinary_vaccines.md) | ESTABLISHED | POPULATION | Vaccines, diagnostics and therapeutics for farm and companion animals, central to controlling zoonoses and reducing antibiotic use. |
...
| 1962 | Murashige and Skoog medium standardises plant tissue culture |
| 1983 | First transgenic plants produced |
| 1996 | Commercial planting of genetically modified crops begins |
| 2001 | Genomic selection proposed and later transforms livestock breeding |
| 2012 | CRISPR-Cas9 opens routine genome editing in crops and livestock |
