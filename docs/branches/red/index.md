...
|---|---|---|---|
| [Pharmaceutical Biotechnology](pharmaceutical_biotechnology.md) | ESTABLISHED | INDUSTRIAL | Discovery, production and formulation of biologic medicines made in living expression systems rather than by chemical synthesis. |
| [Antibody Engineering](antibody_engineering.md) | ESTABLISHED | BENCH | Designing and optimising antibody-derived molecules for affinity, specificity, half-life and effector function. |
| [Vaccine Development](vaccine_development.md) | ESTABLISHED | POPULATION | Design, manufacture and evaluation of prophylactic and therapeutic vaccines across live, subunit and nucleic-acid platforms. |
| [Gene Therapy](gene_therapy.md) | COMMERCIAL | BENCH | Treating disease by adding, silencing, replacing or editing genetic material inside a patient's cells. |
| [Cell Therapy](cell_therapy.md) | COMMERCIAL | BENCH | Using living cells as the therapeutic agent, autologous or allogeneic, often after genetic modification to redirect their function. |
| [Regenerative Medicine and Tissue Engineering](regenerative_medicine.md) | PILOT | BENCH | Restoring the structure and function of damaged tissue by combining cells, scaffolds and signalling molecules. |
| [Molecular Diagnostics](molecular_diagnostics.md) | ESTABLISHED | BENCH | Detecting disease, pathogens and genetic variation by reading nucleic acids and proteins rather than by culture or morphology. |
| [Pharmacogenomics](pharmacogenomics.md) | COMMERCIAL | POPULATION | Using inherited genetic variation to predict drug response, dose requirement and adverse-reaction risk. |

## Branch history

| Year | Event |
|---:|---|
| 1922 | Insulin first used to treat a patient with diabetes |
| 1953 | Structure of DNA published |
| 1973 | Recombinant DNA technology demonstrated |
| 1975 | Monoclonal antibodies produced by hybridoma |
| 1982 | First recombinant medicine approved |
| 2003 | Human Genome Project completed |
| 2017 | First gene therapy and first CAR-T product approved in the United States |
| 2020 | Messenger RNA vaccines deployed at population scale |
