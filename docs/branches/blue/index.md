...
|---|---|---|---|
| [Marine Genomics](marine_genomics.md) | ESTABLISHED | POPULATION | Sequencing and analysing the genomes of marine organisms and communities, including the great majority that cannot be cultured. |
| [Marine Natural Products](marine_natural_products.md) | COMMERCIAL | BENCH | Discovery and development of pharmacologically active compounds from marine organisms, where supply rather than discovery is the constraint. |
| [Marine Enzymes](marine_enzymes.md) | COMMERCIAL | INDUSTRIAL | Enzymes from marine organisms whose adaptations to cold, pressure and salt give them properties terrestrial enzymes do not have. |
| [Algal Biotechnology](algal_biotechnology.md) | COMMERCIAL | INDUSTRIAL | Cultivation of microalgae and cyanobacteria for pigments, lipids, proteins and speciality compounds, and the harvest cost that governs it. |
| [Seaweed Cultivation](seaweed_cultivation.md) | ESTABLISHED | FIELD | Farming macroalgae at sea for food, hydrocolloids and feed, one of the largest forms of aquaculture and requiring no land, fresh water or feed. |
| [Aquaculture Biotechnology](aquaculture_biotechnology.md) | ESTABLISHED | POPULATION | Breeding, health management and feed technology for farmed aquatic animals, now the source of about half the fish that people eat. |
| [Marine Biomaterials](marine_biomaterials.md) | COMMERCIAL | INDUSTRIAL | Structural materials from marine organisms, chiefly polysaccharides, collagens and mineralised composites, mostly recovered from waste. |
| [Marine Biofouling Control](marine_biofouling_control.md) | ESTABLISHED | INDUSTRIAL | Preventing marine organisms from colonising submerged surfaces, and the shift from broad-spectrum biocides to non-toxic and biological methods. |

## Branch history

| Year | Event |
|---:|---|
| 1951 | Unusual nucleosides isolated from a Caribbean sponge provide the template for the first antiviral and anticancer drugs of marine origin |
| 1962 | Green fluorescent protein is isolated from a jellyfish |
| 1969 | Cytarabine, developed from marine sponge nucleoside chemistry, is approved for leukaemia |
| 1977 | Hydrothermal vent ecosystems are discovered, and with them communities independent of sunlight |
| 1991 | A thermostable polymerase from a deep-sea hyperthermophile enters routine laboratory use |
| 2004 | Ziconotide, derived from a cone snail venom peptide, is approved for severe chronic pain |
| 2007 | Trabectedin, from a Caribbean tunicate and supplied by semisynthesis, is approved in Europe |
| 2023 | An international agreement on marine biological diversity beyond national jurisdiction addresses marine genetic resources for the first time |
