...
|---|---|---|---|
| [Bioremediation](bioremediation.md) | ESTABLISHED | FIELD | Using microorganisms to degrade contaminants in soil and groundwater, limited by bioavailability rather than by biodegradability. |
| [Bioaugmentation](bioaugmentation.md) | COMMERCIAL | FIELD | Introducing organisms into an environment to perform a degradation, which usually fails because the resident community outcompetes them, and which works where the capability was genuinely absent. |
| [Phytoremediation](phytoremediation.md) | COMMERCIAL | FIELD | Using plants to extract, degrade, stabilise or hydraulically contain contamination, limited to the depth roots reach and to timescales measured in growing seasons. |
| [Wastewater Treatment](wastewater_treatment.md) | ESTABLISHED | INDUSTRIAL | Continuous treatment of sewage and effluent by managed microbial communities, in which the engineering selects the organisms rather than supplying them. |
| [Biowaste Treatment](biowaste_treatment.md) | ESTABLISHED | INDUSTRIAL | Anaerobic digestion and composting of organic waste into methane and soil amendment, where the economics turn on avoided disposal cost and the failures turn on feedstock contamination. |
| [Air Biotreatment](air_biotreatment.md) | ESTABLISHED | INDUSTRIAL | Treating contaminated air by passing it through a wet biofilm, where the limit is what will dissolve rather than what the organisms will degrade. |
| [Biomining](biomining.md) | ESTABLISHED | INDUSTRIAL | Recovering metals from low-grade ore using iron and sulphur oxidising bacteria, which is acid mine drainage performed deliberately inside a lined containment. |
| [Environmental Biomonitoring](environmental_biomonitoring.md) | ESTABLISHED | POPULATION | Using organisms and their traces to measure environmental condition, which records exposure over time where a chemical sample records a concentration at an instant. |
| [Biodiversity Conservation](biodiversity_conservation.md) | COMMERCIAL | POPULATION | Applying genetic and reproductive technologies to conserving species, which manages the consequences of habitat loss rather than its cause. |

## Branch history

| Year | Event |
|---:|---|
| 1914 | Activated sludge treatment is developed, and becomes the process protecting the water supply of most of the urban world |
| 1947 | The bacteria responsible for acid mine drainage are identified, and later turned into a mining technology |
| 1972 | Comprehensive water pollution legislation makes biological treatment a legal requirement rather than a municipal choice |
| 1980 | A patent on an oil-degrading bacterium establishes that a living organism may be patented |
| 1989 | Shoreline bioremediation is deployed at scale after a major oil spill |
| 1995 | Monitored natural attenuation is accepted as a remediation strategy, making measurement an approved intervention |
| 2010 | Deep-water oil release tests bioremediation under conditions nobody had planned for |
| 2016 | Environmental DNA becomes an accepted method for surveying what lives in a body of water |
