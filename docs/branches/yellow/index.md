...
|---|---|---|---|
| [Food Fermentation](food_fermentation.md) | ESTABLISHED | INDUSTRIAL | Controlled microbial transformation of food and drink, the oldest biotechnology and still among the largest by volume. |
| [Precision Fermentation](precision_fermentation.md) | COMMERCIAL | INDUSTRIAL | Producing specific animal proteins and other defined food molecules by engineered microorganisms rather than by animals. |
| [Alternative Proteins](alternative_proteins.md) | ESTABLISHED | INDUSTRIAL | Protein foods from plants, fungi and insects intended to replace animal products by resembling them in use rather than in molecule. |
| [Cultivated Meat](cultivated_meat.md) | PILOT | PILOT | Growing animal muscle and fat cells in culture to produce meat without raising or slaughtering an animal. |
| [Probiotics and Prebiotics](probiotics_and_prebiotics.md) | COMMERCIAL | POPULATION | Live microorganisms and the substrates that feed them, taken to modify the gut microbial community, with strain-specific and uneven evidence. |
| [Food Biopreservation](food_biopreservation.md) | ESTABLISHED | INDUSTRIAL | Using microorganisms, their antimicrobial products and bacteriophages to extend shelf life and control pathogens without changing the food. |
| [Food Safety Biotechnology](food_safety_biotechnology.md) | ESTABLISHED | POPULATION | Molecular detection of pathogens, toxins, allergens and adulteration in food, and the genomic tracing of outbreaks to their source. |
| [Biofortification](biofortification.md) | COMMERCIAL | POPULATION | Raising the micronutrient content of staple crops by breeding or engineering, so the nutrient travels with the seed rather than through a supply chain. |
| [Nutrigenomics](nutrigenomics.md) | EMERGING | POPULATION | The interaction between diet and the genome, where monogenic effects are established and the polygenic personalisation being sold is not. |

## Branch history

| Year | Event |
|---:|---|
| -7000 | Fermented beverages are produced, predating writing and much of settled agriculture |
...
| 1907 | Lactic acid bacteria are proposed as beneficial to health, the origin of the probiotic idea |
| 1990 | Fermentation-produced chymosin becomes the first recombinant enzyme widely accepted in the food chain |
| 1997 | Novel food authorisation is established in European law, making prior approval the rule for unfamiliar foods |
| 2013 | The first cultivated meat burger is presented publicly |
| 2020 | Precision fermentation dairy proteins reach the market without an animal in the process |
