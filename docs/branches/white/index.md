...
- Is a biobased product genuinely lower impact, or only lower carbon at the point of use?
- How is a process that works in a two-litre flask made to work in a two-hundred-cubic-metre vessel?
- Should feedstock come from food crops, from residues, or from carbon dioxide directly?
- What happens to a biodegradable material that is never actually composted?

## Records

| Record | Maturity | Scale | Summary |
|---|---|---|---|
| [Industrial Enzymes](industrial_enzymes.md) | ESTABLISHED | INDUSTRIAL | Discovery, engineering and large-scale production of enzymes used as catalysts in detergents, food, textiles, paper, feed and chemistry. |
| [Biocatalysis and Enzymatic Synthesis](biocatalysis.md) | COMMERCIAL | INDUSTRIAL | Designing chemical synthesis around enzymes as the catalytic step, in place of metal catalysis, protecting groups and organic solvents. |
| [Metabolic Engineering](metabolic_engineering.md) | COMMERCIAL | INDUSTRIAL | Rewiring the metabolism of a living cell so that it converts a cheap feedstock into a chosen product at commercially useful yield. |
| [Microbial Fermentation](microbial_fermentation.md) | ESTABLISHED | INDUSTRIAL | Cultivating microorganisms at industrial scale under controlled and usually sterile conditions, so that a strain performs in a vessel what it was engineered to do. |
| [Bioprocess Engineering](bioprocess_engineering.md) | ESTABLISHED | INDUSTRIAL | Designing, scaling and operating the equipment train that turns a laboratory biological process into reproducible manufacture, including everything downstream of the vessel. |
| [Biofuels and Bioenergy](biofuels.md) | COMMERCIAL | INDUSTRIAL | Producing liquid and gaseous transport fuels from biological feedstocks by fermentation, conversion or hydroprocessing. |
| [Biobased Chemicals](biobased_chemicals.md) | COMMERCIAL | INDUSTRIAL | Producing bulk and speciality chemicals from biological feedstocks in place of petroleum, by fermentation and catalytic upgrading. |
| [Biopolymers and Bioplastics](biopolymers.md) | COMMERCIAL | INDUSTRIAL | Polymers produced from biological feedstocks or by living organisms, including both durable biobased plastics and compostable materials. |
| [Cell-Free Biomanufacturing](cell_free_biomanufacturing.md) | PILOT | BENCH | Producing proteins and metabolites using extracted cellular machinery rather than living cells, programmed directly with DNA or RNA. |

## Branch history

| Year | Event |
|---:|---|
| 1833 | Payen and Persoz isolate diastase, the first enzyme preparation obtained from a living source |
| 1897 | Buchner shows that cell-free yeast extract still ferments sugar, separating biochemistry from vitalism |
| 1916 | Weizmann develops acetone-butanol fermentation, the first large industrial fermentation process |
| 1941 | Submerged deep-tank fermentation is developed for penicillin and becomes the template for the industry |
| 1974 | Bacterial proteases become standard in laundry detergents, the largest enzyme market by volume |
| 1993 | Directed evolution is demonstrated, allowing enzymes to be improved without understanding their mechanism |
| 2004 | The United States Department of Energy publishes its list of top value-added chemicals from biomass, which sets the field's product agenda for two decades |
| 2018 | The Nobel Prize in Chemistry is awarded for directed evolution of enzymes and phage display |
