...
Editorial rule 3 in [`STYLE_GUIDE.md`](STYLE_GUIDE.md) requires the price, the
...
This is a stated bias, written down in [`NOTICE.md`](NOTICE.md) and
...
inside a service you host is not distribution. See [`NOTICE.md`](NOTICE.md) §2,
