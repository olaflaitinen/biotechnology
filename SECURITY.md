...
each, and what it accepts, is in [`THREAT_MODEL.md`](THREAT_MODEL.md).
...
three are analysed in [`THREAT_MODEL.md`](THREAT_MODEL.md).
...
[`CHANGELOG.md`](CHANGELOG.md) and [`AUTHORS.md`](AUTHORS.md) unless you ask
otherwise.
...
See [`NOTICE.md`](NOTICE.md) section 6 for the full disclaimer, and
[`THREAT_MODEL.md`](THREAT_MODEL.md) section 5 for the risks this project
